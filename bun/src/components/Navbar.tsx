    ...
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${
          isScroll
            ? "bg-white/50 backdrop-blur-lg shadow-xs dark:bg-darkTheme dark:shadow-white/20"
            : ""
        }`}
      >
        <a href="#top">
        ...
        <ul
          className={`hidden md:flex items-center gap-6  lg:gap-8 rounded-full px-12 py-3 ${
            isScroll
              ? ""
              : "bg-white/50 shadow-xs dark:border dark:border-white/50 dark:bg-transparent"
          }`}
        >
          <li>
