<template>
  <view class="userLayout pageBe" v-if="userinfo">
    ...
    <view class="section">
      <view class="list">
        ...
        <navigator
          url="/pages/notice/list?id=6536358ce0ec19c8d67fbe82"
          class="row"
        >
          <view class="left">
  ...
  <!-- 	<view class="userLayout pageBe">
		...
		<view class="section">
			<view class="list">
				<view class="row" v-for="(item,index) in listOfIcon" :key="index">
					<view class="left">
		...
		<view class="section">
			<view class="list">
				<view class="row" v-for="(item,index) in listOfIcon2" :key="index">
					<view class="left">
						<uni-icons :type="item.icon" size="20"></uni-icons>
						<view class="text">
							{{ item.name}}
...
<script setup>
import { ref } from "vue";
import { apiUserInfo, apiUserWallList } from "@/api/apis";
